...
void main() => runApp(SpotifyTestPage());

class SpotifyTestPage extends StatefulWidget {
  @override
  _SpotifyTestPageState createState() => _SpotifyTestPageState();
}

class _SpotifyTestPageState extends State<SpotifyTestPage> {
